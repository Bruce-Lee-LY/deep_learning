...
AlexNet_V2_MODEL_PATH = "model/AlexNet_V2/"
AlexNet_V2_MODEL_NAME = "AlexNet_V2_train_step"
AlexNet_V2_MODEL_RECORD = "AlexNet_V2_model_record.json"
AlexNet_V2_TRAIN_RECORD = "AlexNet_V2_train_record.png"
AlexNet_V2_TENSORBOARD_PATH = "tensorboard/AlexNet_V2/"
...
class AlexNet_V2:
    def __init__(self, is_training=True):
        ...
        self.val_acc_list = []
        self.val_loss_list = []
        self.model_path = AlexNet_V2_MODEL_PATH
        self.model_name = AlexNet_V2_MODEL_NAME
        self.model_record = AlexNet_V2_MODEL_PATH + AlexNet_V2_MODEL_RECORD
        self.train_record = AlexNet_V2_MODEL_PATH + AlexNet_V2_TRAIN_RECORD
        self.tensorboard = False
        if self.tensorboard:
            self.tensorboard_path = AlexNet_V2_TENSORBOARD_PATH
            self.feature_map = {}
    ...
    def build_with_slim(self):
        ...
        with slim.arg_scope(alexnet.alexnet_v2_arg_scope()):
            self.output, self.end_points = alexnet.alexnet_v2(
    ...
    def train(self):
        ...
        while self.epoch < self.max_epoch:
            ...
            while self.caltch_256.can_get_train_batch():
                batch_start = datetime.now()
                batch += 1
                self.learning_rate = 0.01 if self.train_step < 500 else (
                    0.001 if self.train_step < 100000 else 0.0001)
                self.train_step += 1
