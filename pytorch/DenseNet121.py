...
DenseNet121_MODEL_PATH = "model/DenseNet121/"
DenseNet121_MODEL_NAME = "DenseNet121_train_step-"
DenseNet121_MODEL_RECORD = "DenseNet121_model_record.json"
DenseNet121_TRAIN_RECORD = "DenseNet121_train_record.png"
...
class DenseNet121():
    def __init__(self, seed=0):
        ...
        self.model_path = DenseNet121_MODEL_PATH
        self.model_name = DenseNet121_MODEL_NAME
        self.model_record = DenseNet121_MODEL_PATH + DenseNet121_MODEL_RECORD
        self.train_record = DenseNet121_MODEL_PATH + DenseNet121_TRAIN_RECORD
        self.width = 224
        self.height = 224
        ...
        self.expand_width = round(self.width / 0.875)
        self.expand_height = round(self.height / 0.875)
        self.expand_size = (self.expand_height, self.expand_width)
        self.degrees = 15
    ...
    def produce(self):
        ...
        self.val_transform = transforms.Compose(
            [
                transforms.Resize(
                    self.expand_size), transforms.CenterCrop(
                    self.size), transforms.ToTensor(), transforms.Lambda(
                    lambda x: x.repeat(
        ...
        self.train_num = round(len(self.train_dataset)
                               * (1 - self.val_fraction))
        self.val_num = len(self.train_dataset) - self.train_num
