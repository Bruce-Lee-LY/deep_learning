...
class LeNet_5_net(nn.Module):
    def __init__(self, num_classes):
        super(LeNet_5_net, self).__init__()
...
class LeNet_5():
    def __init__(self, seed=0):
        ...
        self.val_acc_list = []
        self.val_loss_list = []
        self.dataset_path = MNIST_DATASET_PATH
    ...
    def produce(self):
        ...
        print("MNIST: train_num = {}, train_batch_size = {}, train_batch = {}".format(
            self.train_num, self.train_batch_size, self.train_num // self.train_batch_size))
        print("MNIST: val_num = {}, val_batch_size = {}, val_batch = {}".format(
            self.val_num, self.val_batch_size, self.val_num // self.val_batch_size))
        print("MNIST: test_num = {}, test_batch_size = {}, test_batch = {}".format(
    ...
    def build(self):
        self.model = LeNet_5_net(self.num_classes).to(self.device)
        print(self.model)
